...
pkgdatadir = $(datadir)/rkcoin
pkgincludedir = $(includedir)/rkcoin
pkglibdir = $(libdir)/rkcoin
pkglibexecdir = $(libexecdir)/rkcoin
...
ACLOCAL = ${SHELL} /root/prod/litecoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/prod/litecoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/prod/litecoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/prod/litecoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
BITCOIN_CLI_NAME = rkcoin-cli
BITCOIN_DAEMON_NAME = rkcoind
BITCOIN_GUI_NAME = rkcoin-qt
BITCOIN_TX_NAME = rkcoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Rkcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Rkcoin Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/prod/litecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = rkcoin
PACKAGE_BUGREPORT = https://github.com/rkcoin-project/rkcoin/issues
PACKAGE_NAME = Rkcoin Core
PACKAGE_STRING = Rkcoin Core 0.16.3
PACKAGE_TARNAME = rkcoin
PACKAGE_URL = https://rkcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /root/prod/litecoin
abs_srcdir = /root/prod/litecoin
abs_top_builddir = /root/prod/litecoin
abs_top_srcdir = /root/prod/litecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/prod/litecoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Rkcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Rkcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Rkcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Rkcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
