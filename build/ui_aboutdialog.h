...
"Copyright &copy; 2011-YYYY The Rkcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Rkcoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Rkcoin</b> version", Q_NULLPTR));
