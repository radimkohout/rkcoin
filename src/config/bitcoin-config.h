...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Rkcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Rkcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/rkcoin-project/rkcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rkcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rkcoin Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rkcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://rkcoin.org/"
