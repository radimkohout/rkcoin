...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rkcoin transaction") + "\n" +
              "  rkcoin-tx [options] -create [commands]   " + _("Create hex-encoded rkcoin transaction") + "\n" +
              "\n";
