...
{
    const char* pszTimestamp = "This is Rkcoin";
    const CScript genesisOutputScript = CScript() << ParseHex(/*"040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9"*/"04caebb2a25d6cb318de067693e7f09df5ad6ed8f48f14001540c8d5158454adc1bc25f0bb8f84bcf7a0c47fad7859b2bbe23f44893adfeb3c87def71c960b0566") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 3*consensus.nMinerConfirmationWindow/4; // 75% of 8064
        consensus.nMinerConfirmationWindow = consensus.nPowTargetTimespan / consensus.nPowTargetSpacing * 4; // nPowTargetTimespan / nPowTargetSpacing * 4
...
*/
        ...
        genesis = CreateGenesisBlock(1545077209, 2084729968, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        printf("%s\n", consensus.hashGenesisBlock.ToString().c_str());
	assert(consensus.hashGenesisBlock == uint256S("0xe653036c43456cc26cad82b8eeeb92ce7a0437a6fecabe48e4e0998b938a8ae3"));
        assert(genesis.hashMerkleRoot == uint256S("0x136a2e6f7b189bb8a6f7febc4c4e76f321c1dc5b76f4b9247369d1adb10f200d"));

        // Note that of those with the service bits flag, most only support a subset of possible options
/*        vSeeds.emplace_back("seed-a.rkcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.rkcointools.com");
        vSeeds.emplace_back("dnsseed.rkcoinpool.org");
...
*/
        ...
        genesis = CreateGenesisBlock(1545077209, 385657479, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
	printf("%s\n", consensus.hashGenesisBlock.ToString().c_str());
	printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0xb3dbf6faba6146540eb896dc0782227c410e54f370569a69fa1c0ef8cda5e1dd"));
        assert(genesis.hashMerkleRoot == uint256S("0x136a2e6f7b189bb8a6f7febc4c4e76f321c1dc5b76f4b9247369d1adb10f200d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.rkcointools.com");
        vSeeds.emplace_back("seed-b.rkcoin.loshan.co.uk");
