...
uint256 hashGenesisBlock("0xe653036c43456cc26cad82b8eeeb92ce7a0437a6fecabe48e4e0998b938a8ae3");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 100000 blocks, which will occur approximately every x years
    nSubsidy >>= (nHeight / 100000); // Rkcoin: 100k blocks in ~x years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // Rkcoin: 1 day
static const int64 nTargetSpacing = 1.25 * 60; // Rkcoin: 1.25 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb3dbf6faba6146540eb896dc0782227c410e54f370569a69fa1c0ef8cda5e1dd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04caebb2a25d6cb318de067693e7f09df5ad6ed8f48f14001540c8d5158454adc1bc25f0bb8f84bcf7a0c47fad7859b2bbe23f44893adfeb3c87def71c960b0566") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1545077209;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084729968;

        if (fTestNet)
        {
            block.nTime    = 1545077209;
            block.nNonce   = 385657479;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x136a2e6f7b189bb8a6f7febc4c4e76f321c1dc5b76f4b9247369d1adb10f200d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc6, 0xb2, 0xd4 }; // Rkcoin: increase each by adding 2 to bitcoin's value.
