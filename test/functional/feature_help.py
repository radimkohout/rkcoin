...
"""Verify that starting rkcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rkcoin with -h for help text")
        ...
        self.log.info("Start rkcoin with -version for version information")
