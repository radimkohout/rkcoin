...
* rkcoin.conf: contains configuration settings for rkcoind or rkcoin-qt
* rkcoind.pid: stores the process id of rkcoind while running
...
* debug.log: contains debug information and general logging generated by rkcoind or rkcoin-qt
